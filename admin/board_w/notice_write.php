        ...
        <div class="panel reserve">
                	...
                	<tr>
                        ...
                        <td>
                        	<div class="confing_box">
                        		<input type="text" name="send_m_title" id="send_m_title" placeholder="공지명을 입력해 주세요." />
                        	</div>
                        </td>
                    </tr>
                    <tr>
            ...
            <div class="panel_tit">
            	<div>
                    ...
                    <a href="/board_w/notice_list.php" id="adm_btn_event_cancel" class="btn h30 btn_green" style="color: white">목록</a>
                </div>
            </div>
        </div>
        <!-- END list -->
	...
	$("#adm_btn_notice_send").click(function(){
            ...
            if (result){
                    ...
                    $.ajax({
                            type: 'post',
                            dataType: 'json',
                            url: '/board_w/_notice_prc.php',
                            data:{'msg_title':msg_title,'filename':filename,'detail':msg_content, 'status':status},
