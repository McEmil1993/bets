...
if($db_conn) {
    ...
    $p_data['sql'] = " SELECT * FROM events WHERE idx = ".$p_data['idx'];
                	...
                	<tr>
                        ...
                        <td>
                        	<div class="confing_box">
                        		<input type="text" name="send_m_title" id="send_m_title" placeholder="이벤트명을 입력해 주세요." value="<?=$db_dataArr['name']?>"/>
                        	</div>
                        </td>
                    </tr>
                    <tr>
	...
	$("#adm_btn_event_send").click(function(){
            ...
            if (result){
                    ...
                    $.ajax({
                            type: 'post',
                            dataType: 'json',
                            url: '/board_w/_event_prc_update.php',
