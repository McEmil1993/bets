...
if($db_conn) {
    ...
    // member list
    $p_data['sql'] = "select idx, id, nick_name from member where status=1; ";
    $db_dataArr_mem = $MEMAdminDAO->getQueryData($p_data);
            ...
            <div class="tline">
                <table class="mlist">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="set_msg" id="set_msg" onchange="javascript:getSetMsg(this.value);" style="width: 90%">
							...
							<a href="/board_w/template_write.php" class="btn h30 btn_blu">새 템플릿 등록</a>
                        </td>
                    </tr>
                    <tr>
