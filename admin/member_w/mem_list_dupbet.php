...
if ($db_conn) {
    ...
    $p_data["sql_where"] = " where a.idx > 0 and a.is_monitor_bet='Y' and a.u_business = ".GENERAL;
                                    ...
                                    foreach ($db_dataArr as $row) {
                                        ...
                                        <tr onmouseover="this.style.backgroundColor = '#FDF2E9';" onmouseout="this.style.backgroundColor = '#ffffff';">
                                            ...
                                            <?php }else{ ?>
                                                ...
                                                <?php } ?>
                                            <?php } ?>
            <?= $db_dis_id = !empty($db_dis_id) ? $db_dis_id : '' ?>
            <?= $db_m_idx = !empty($db_m_idx) ? $db_m_idx : 0 ?>
                                            <td style='text-align:left'>
