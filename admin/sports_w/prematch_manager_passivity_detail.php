...
if ($db_conn) {
    ...
    $s = $LSBAdminDAO->getDetailSportsFixturesList($fixture_id, 1, $p_data);
    ...
    $result_sum_cnt = $LSBAdminDAO->getTotalBetSumCNT($fixture_id, 1);
        ...
        <div class="wrap">
            ...
            <div class="con_wrap">
                ...
                <div class="panel search_box">
                            ...
                            <div style="float:right"><a href="#" onclick="fn_go_sprots_menu1_1();" class="btn h30 btn_blu">목록</a></div><!-- href="prematch_manager_passivity.php"  -->
                    <div class="mline">
                        <table class="mlist">
                            <tr>
                                <th width="10%">경기일시</th>
                                <td class="input__btn"><input id="game_start_date" name ="game_start_date" type="text" value="<?= $row_data['fixture_start_date'] ?>"> <a href="#" class="btn h30 btn_blu" onclick="on_modify_game_start_date(<?= $fixture_id ?>, 1)">적용</a> <a href="#" class="btn h30 btn_dark" onclick="on_modify_game_start_date_release(<?= $fixture_id ?>, 1)">해제</a></td>
                                <th width="10%">종목</th>
                ...
                <div class="panel reserve">
                    <div class="panel_tit">
                        <div class="search_form fl ml5">
                            ...
                            <div><a href="#" class="btn h30 btn_blu" onclick="onBtnClickBatchApplication(<?= $row_data['fixture_sport_id'] ?>, '<?= $row_data['fixture_start_date'] ?>',<?= $row_data['fixture_id'] ?>, 1)">일괄적용</a></div>
                            
                            <b class="ml20">2차 암호</b><input id="second_pass" name = "second_pass" type="password" class="ml5" placeholder="암호를 입력하세요." value=""/>
                            <div><a href="#" class="btn h30 btn_orange ml5" onclick="onBtnClickTotalHitException(<?= $row_data['fixture_sport_id'] ?>, '<?= $row_data['fixture_start_date'] ?>',<?= $row_data['fixture_id'] ?>, 1)">전체적특</a></div>
                            <div><a href="#" class="btn h30 btn_blu" onclick="onBtnClickTotalCalculate(<?= $row_data['fixture_sport_id'] ?>, '<?= $row_data['fixture_start_date'] ?>',<?= $row_data['fixture_id'] ?>, 1)">전체정산</a></div>
                            <div class="ml5 fr"><a href="#" class="btn h30 btn_dblu" onclick="onBtnClickTotalBeforeCalculate(<?= $row_data['fixture_id'] ?>, 1)">전체마감전</a></div>
...
<?php } ?>
                                        ...
                                        <!-- 배당 입력 부분 위치 변경 -->
                                        <!-- <?php
                                        $is_in_market = array(6, 9, 22, 23);
                                        //$is_in_market = array(2, 3, 11, 21, 28, 30, 31, 45, 46, 47, 53, 64, 65, 66, 67, 77, 95, 101, 102, 153, 155, 220, 221, 236, 281, 342, 866, 1558);
                                        if (false === in_array($item['markets_id'], $is_in_market)) {
                                            $col = 0;
                                            ?> 
                                            <?php
    ...
    <?php } ?> -->
                                        ...
                                        $j_bet_data = implode(',', $arr_bet_data);
                                        // 아직 일괄적용          
    ...
    <?php if (4 == $item['markets_id'] || 390 == $item['markets_id'] || 84 == $item['markets_id']) { ?>
        ...
        <?php } ?>
                                                    <a href="#" class="btn h30 btn_dblu" onclick="onBtnClickBeforeCalculate(<?= $fixture_id ?>, 1,<?= $item['markets_id'] ?>, '<?= $item['bet_base_line'] ?>', '<?= $item['admin_bet_status'] ?>')">마감전</a>
                                                </div>
    ...
    <?php } ?>
                                ...
                                <tr>
                                    ...
                                    if (true === in_array($item['markets_id'], $arr_over_under)) {
                                        ...
                                        $count = 0;
                                        //$win_value = $betData['1'];
                                        $win_value = true === isset($betData['1']) ? $betData['1'] : '';
                                        if ('' != $win_value) {
                                            $count = GameCode::display_bet_name('ON', $idx, $item, $win_value, $fixture_id, $fixture_start_date, $count);
                                        }
                                        ...
                                        $lose_value = true === isset($betData['2']) ? $betData['2'] : '';
                                        if ('' != $lose_value) {
                                            $count = GameCode::display_bet_name('ON', $idx, $item, $lose_value, $fixture_id, $fixture_start_date, $count);
                                        }
...
endforeach; ?>
        ...
        <script type="text/javascript">
            ...
            function fn_go_sprots_menu1_1() {
                ...
                url = "prematch_manager_passivity.php" + previous_page_data_url
