...
if ($db_conn) {
    ...
    CommonUtil::logWrite("prematch_mg_detail : " . json_encode($row_data), "info");
...
<html lang="ko">
    ...
    <body>
        ...
        <div class="wrap">
            ...
            <!-- Contents -->
            <div class="con_wrap">
                <?php $bet_base_line = explode(' ', true === isset($row_data['bet_base_line']) ? $row_data['bet_base_line'] : ''  )[0]; ?>
                <div class="title">
                    <a href="">
                ...
                <div class="panel search_box">
                        ...
                        <div style="float:right"><a href="#" onclick="fn_go_sprots_menu1_1();" class="btn h30 btn_blu">목록</a></div><!-- href="prematch_manager.php"  -->
                    ...
                    <div class="mline">
                        <table class="mlist">
                            ...
                            <tr>
                                ...
                                <th>상태</th>
                                <td> <?= GameStatusUtil::get_display_stauts_name($row_data['display_status'], 1) ?></td>
                                <th>총 배팅액</th>
                ...
                <div class="panel reserve">
                    <div class="panel_tit">
                        <div class="search_form fl">
                            ...
                            <div class="ml5"><a href="#" class="btn h30 btn_blu" onclick="onBtnClickBatchApplication(<?= $row_data['fixture_sport_id'] ?>, '<?= $row_data['fixture_start_date'] ?>',<?= $row_data['fixture_id'] ?>, 1)">일괄 적용</a></div>
                        </div>

                        <div class="search_form fr">
                            2차 암호<input id="second_pass" name = "second_pass" type="password" class="ml5" placeholder="암호를 입력하세요." value=""/>
                            <div class="ml5 fr"><a href="#" class="btn h30 btn_orange" onclick="onBtnClickTotalHitException(<?= $row_data['fixture_sport_id'] ?>, '<?= $row_data['fixture_start_date'] ?>',<?= $row_data['fixture_id'] ?>, 1)">전체적특</a></div>
                            <div class="ml5 fr"><a href="#" class="btn h30 btn_blu" onclick="onBtnClickTotalCalculate(<?= $row_data['fixture_sport_id'] ?>, '<?= $row_data['fixture_start_date'] ?>',<?= $row_data['fixture_id'] ?>, 1)">전체정산</a></div>
...
<?php endforeach; ?>
        ...
        <script type="text/javascript">
            ...
            function fn_go_sprots_menu1_1() {
                ...
                url = "prematch_manager.php" + previous_page_data_url
