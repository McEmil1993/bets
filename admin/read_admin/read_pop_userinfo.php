...
if ($db_conn) {
    ...
    $p_data['sql'] .= ", account_number, account_name, account_bank, is_monitor, is_monitor_charge, is_monitor_security, is_monitor_bet, u_business, recommend_code ";
    ...
    $p_data_dis['sql'] = "select idx, id, nick_name, u_business from member ";
    ...
    $arr_game_type_sql['sql'] = "select lsports_game_type.id,lsports_game_type.ko_name,member_game_type.status from member_game_type
            ...
            where member_game_type.member_idx=" . $p_data['m_idx'] . " order by game_type ";
                            ...
                            <table class="mlist">
                                <tr>
                                    <td style="width: 560px; vertical-align: top">
                                        <?php
                                        include_once(_BASEPATH . '/read_admin/read_pop_userinfo_inc.php');
                                        ?>
                                    </td>
                                    <td style="vertical-align: top">
<?php
include_once(_BASEPATH . '/read_admin/read_pop_userinfo_inc_memo.php');
?>
                                        <div style="padding: 5px;"></div>
<?php
include_once(_BASEPATH . '/read_admin/read_pop_userinfo_inc_content.php');
?>
                                    </td>
                                </tr>
        ...
        <script>
            ...
            function setUserinfo() {
                ...
                var param_val = {
                    m_idx: <?= $db_m_idx ?>, u_status: u_status, birth: birth, u_hp01: u_hp01, u_hp02: u_hp02, u_hp03: u_hp03
                    , u_mobile_carrier: u_mobile_carrier, u_level: u_level, u_recomm_user: u_recomm_user
                };

                var str_msg = '회원 정보를 변경 하시겠습니까?';
                var result = confirm(str_msg);
                if (result) {
                    var getUrl = '/read_admin/_read_set_userinfo.php';
            ...
            function setMoneyPoint(mtype, setkind) {
                ...
                var param_url = '/read_admin/_read_set_userinfo_money.php';
                ...
                if (result) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        url: param_url,
                        data: {'m_idx': m_idx, 'mtype': mtype, 'mkind': setkind, 'money': money, 'point': point},
                        success: function (data) {
