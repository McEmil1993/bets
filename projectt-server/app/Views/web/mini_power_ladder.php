    ...
    const getBetList = function(currentPage){
        ...
        $.ajax({
            ...
            for (const[key, betInfo] of Object.entries(list)) {
                ...
                html += "<td class='list1'><span class='font01'>" + `${betInfo['round']}` + ` 회` + "</span></td>"; // + `(${betInfo['ls_fixture_id']})`
            ...
            for (const[key, gameResult] of Object.entries(game_result)) {
                ...
                html2 += "<td class='list1'><span class='font01'>" + round+` 회` +"</td>";// + "</span> " + `(${gameResult['id']})` + "</span>
