...
<?php
    ...
    foreach ($member_bet as $key => $value) {
        if ($game_data -> id == $value -> ls_fixture_id) {
            ...
            if ($betList[$value -> ls_markets_id] -> markets_id == 11001 || $betList[$value -> ls_markets_id] -> markets_id == 11002) {
                $betList[11001] -> max = isset($betList[11001] -> max) ? $betList[11001] -> max - ($value-> total_bet_money) : ($game_config -> max) - ($value-> total_bet_money);
                $betList[11002] -> max = isset($betList[11002] -> max) ? $betList[11002] -> max - ($value-> total_bet_money) : ($game_config -> max) - ($value-> total_bet_money);
            } else if ($betList[$value -> ls_markets_id] -> markets_id == 11003 || $betList[$value -> ls_markets_id] -> markets_id == 11004) {
                $betList[11003] -> max = isset($betList[11003] -> max) ? $betList[11003] -> max - ($value-> total_bet_money) : ($game_config -> max) - ($value-> total_bet_money);
                $betList[11004] -> max = isset($betList[11004] -> max) ? $betList[11004] -> max - ($value-> total_bet_money) : ($game_config -> max) - ($value-> total_bet_money);
            } else if ($betList[$value -> ls_markets_id] -> markets_id == 11005 || $betList[$value -> ls_markets_id] -> markets_id == 11006) {
                $betList[11005] -> max = isset($betList[11005] -> max) ? $betList[11005] -> max - ($value-> total_bet_money) : ($game_config -> max) - ($value-> total_bet_money);
                $betList[11006] -> max = isset($betList[11006] -> max) ? $betList[11006] -> max - ($value-> total_bet_money) : ($game_config -> max) - ($value-> total_bet_money);
            } 
        }
    }
...
<div id="mini_wide_wrap">
    ...
    <div class="mini_wide_left">
    	<div class="mini_left_title">
        	<div class="mini_left_title_game">엔트리 파워사다리</div>
            <div class="mini_left_title_box">제 <span class="mini_left_title_box_font displayRound" style="display: none"></span><span class="mini_left_title_box_font round" style="display: none"></span> 회차</div>
            	...
            	<ul>
                    <?php if('ON' == config(App::class)->IS_EOS_POWERBALL){ ?>
                        ...
                        <?php if('ON' == config(App::class)->IS_POWERBALL){ ?>
                            <a href="/web/minigame?betType=15"><li><img src="/assets_w/images/icon_mini01.png" width="18"> 엔트리 파워볼 </li></a>
                        <?php } ?>
                	<a href="/web/minigame?betType=4"><li style="border:1px solid #009dd9; background: #232323;"><img src="/assets_w/images/icon_mini01.png" width="18">&nbsp; 엔트리 파워사다리</li></a>
    ...
    <div class="mini_wide_center">
    	<div class="mini_title_wrap">
        	<div class="mini_title">엔트리 파워사다리 &nbsp;&nbsp; <span class="mini_round"> 제 <span class="mini_left_title_box_font displayRound"></span> 회차 </span> &nbsp;&nbsp;<span class="mini_time mini_left_title_box_font remain_time"></span></span></div>
        </div>
		<div class="mini_movie_wrap">
        <div class="mini_movie_inner"><iframe defer src="https://ntry.com/scores/power_ladder/live.php" width="830" height="641" scrolling="no" frameborder="0"></iframe></div>
        </div> 
    ...
    <!-- mini_betting_cart -->
        ...
        <div class="mini_cart_wrap">
            <table width="100%" cellspacing="2" cellpadding="0">
                <tr>
                    <td width="10%"><a href="javascript:void(0);" onclick="addMiniGameBet(11001, <?=$betList[11001]->bet_price?>, <?=session()->get('money')?>, <?= isset($betList[11001]->max) ? $betList[11001] -> max : $game_config -> max?> )"><span class="mini_power_btn1"><span class="mini_power_font markets_id_11001"><?=$betList[11001]->markets_name?></span><br><?= $betList[11001]->bet_price ?></span></a></td>
                    <td width="10%"><a href="javascript:void(0);" onclick="addMiniGameBet(11002, <?=$betList[11002]->bet_price?>, <?=session()->get('money')?>, <?= isset($betList[11002]->max) ? $betList[11002] -> max : $game_config -> max?> )"><span class="mini_power_btn2"><span class="mini_power_font markets_id_11002"><?=$betList[11002]->markets_name?></span><br><?= $betList[11002]->bet_price ?></span></a></td>                                                                                                                  
                </tr>
            </table>
            <table width="100%" cellspacing="2" cellpadding="0">
                <tr>
                    <td width="10%"><a href="javascript:void(0);" onclick="addMiniGameBet(11003, <?=$betList[11003]->bet_price?>, <?=session()->get('money')?>, <?= isset($betList[11003]->max) ? $betList[11003] -> max : $game_config -> max?> )"><span class="mini_power_btn1"><span class="mini_power_font markets_id_11003"><?=$betList[11003]->markets_name?></span><br><?= $betList[11003]->bet_price ?></span></a></td>
                    <td width="10%"><a href="javascript:void(0);" onclick="addMiniGameBet(11004, <?=$betList[11004]->bet_price?>, <?=session()->get('money')?>, <?= isset($betList[11004]->max) ? $betList[11004] -> max : $game_config -> max?> )"><span class="mini_power_btn2"><span class="mini_power_font markets_id_11004"><?=$betList[11004]->markets_name?></span><br><?= $betList[11004]->bet_price ?></span></a></td>                                                                                                                  
                </tr>
            </table>
            <table width="100%" cellspacing="2" cellpadding="0">
                <tr>
                    <td width="10%"><a href="javascript:void(0);" onclick="addMiniGameBet(11005, <?=$betList[11005]->bet_price?>, <?=session()->get('money')?>, <?= isset($betList[11005]->max) ? $betList[11005] -> max : $game_config -> max?> )"><span class="mini_power_btn1"><span class="mini_power_font markets_id_11005"><?=$betList[11005]->markets_name?></span><br><?= $betList[11005]->bet_price ?></span></a></td>
                    <td width="10%"><a href="javascript:void(0);" onclick="addMiniGameBet(11006, <?=$betList[11006]->bet_price?>, <?=session()->get('money')?>, <?= isset($betList[11006]->max) ? $betList[11006] -> max : $game_config -> max?> )"><span class="mini_power_btn2"><span class="mini_power_font markets_id_11006"><?=$betList[11006]->markets_name?></span><br><?= $betList[11006]->bet_price ?></span></a></td>                                                                                                                  
                </tr>
            </table> 
        </div>
        <div class="mini_cart_bet">
    ...
    <!-- mini_game_result -->
        <div class="mini_conter_wrap">
            ...
            <div class="mini_center_result tab_container_multi">
                    ...
                    <div id="pladder_pattern_1" class="tab_content_multi"></div>
                    <div id="pladder_pattern_2" class="tab_content_multi"></div>
                    <div id="pladder_pattern_3" class="tab_content_multi"></div>
...
<!--<script type="text/javascript" src="/assets_w/js/game_03_timer.js?v=<?php //echo date("YmdHis"); ?>"></script>-->
...
<script type="text/javascript">
    ...
    $(document).on('click', '.cart_btn1', function () {
        ...
        let memberBetList = [];
            ...
            $.ajax({
                ...
                let path = '/api/bet/addMiniBet?betType=4';
    ...
    const addMiniGameBet = function(markets_id, bet_price, money, max){
        ...
        if(markets_id == 11001 ||markets_id == 11003 || markets_id == 11005) {
        	$('.select_game').addClass('mini_power_c_btn1');
        }
        if(markets_id == 11002 ||markets_id == 11004 || markets_id == 11006) {
    ...
    const getBetList = function(currentPage){
        ...
        $.ajax({
            url: '/minigame/selectMemberMiniGameBet?betType=4',
            type: 'post',
            data: param,
        }).done(function (response) {
            ...
            for (const[key, betInfo] of Object.entries(list)) {
                ...
                let round = result['cnt'];
                result = getAdderResult(result['start'], result['oe'], result['line']);
                //console.log(result);
                // $status = '적중';
                // $statusColor = 'bg_blue';
                ...
                //     $status = '취소';
                //     $statusColor = 'bg_gray';
                // }else if(+betInfo['total_bet_money'] > +betInfo['take_money']){
                //     $status = '낙첨';
                //     $statusColor = 'bg_red';
                // }
                ...
                /* html += "<tr>";
                    html += "<td><span class='font_002'>"+round+"회</span> <span>"+betInfo['ls_fixture_id']+"</span></td>";
                    ...
                    html += "<td><span>"+result+"</span></td>";
                    html += "<td><span class='bet_result_icon "+$statusColor+"'>"+$status+"</span></td>";
                html += "</tr>"; */

                html += "<tr>";
                html += "<td class='mini_list1'><span class='font01'>" + `${betInfo['round']}` + ` 회` + "</span></td>"; // + `(${betInfo['ls_fixture_id']})`
            ...
            for (const[key, gameResult] of Object.entries(game_result)) {
                ...
                html2 += "<tr>";
                    /* html2 += "<td><span class='font_002'>"+round+"회</span> <span>"+gameResult['id']+"</span></td>";
                    ...
                    html2 += "<td class='mini_list1'><span class='font01'>" + round+` 회` +"</td>";// + "</span> " + `(${gameResult['id']})` + "</span>
    ...
    // 사다리 게임 결과
    const getAdderResult = function(start, oe, line){
        let result = '-';
    ...
    const calcResult = function(mybet, result, bet_money, bet_price) {
        ...
        if (mybet === '11001') {
            ...
            //console.log(result, result.indexOf('언더'));
    ...
    const getPatternData = function(){
        ...
        $.ajax({
            ...
            for (const[key, betInfo] of Object.entries(game_result)) {
                ...
                // 결과가 안나왔다.
                if(Number(result['line']) === 0) continue;
                
                let checkData = '';
                let className = 'mini_pattern_blue';
                let name = '좌';
                if(patternType == 1){
                    checkData = result['start'];
                    if(checkData == 'Right'){
            ...
            $('#pladder_pattern_'+patternType).empty();
            $('#pladder_pattern_'+patternType).append(html);
            
            // 삭제할 li 갯수
            let delCount = $('#pladder_pattern_'+patternType).find('li').length - 20;
            $('#pladder_pattern_'+patternType + ' li').each(function (index, item){
                if(index < delCount){
                    item.remove();
                }
            });
