...
foreach ($member_bet as $key => $value) {
    if ($game_data->id == $value->ls_fixture_id) {
        ...
        if ($betList[$value->ls_markets_id]->markets_id == 10001 || $betList[$value->ls_markets_id]->markets_id == 10002) {
            $betList[10001]->max = isset($betList[10001]->max) ? $betList[10001]->max - ($value->total_bet_money) : ($game_config->max) - ($value->total_bet_money);
            $betList[10002]->max = isset($betList[10002]->max) ? $betList[10002]->max - ($value->total_bet_money) : ($game_config->max) - ($value->total_bet_money);
        } else if ($betList[$value->ls_markets_id]->markets_id == 10003 || $betList[$value->ls_markets_id]->markets_id == 10004) {
            $betList[10003]->max = isset($betList[10003]->max) ? $betList[10003]->max - ($value->total_bet_money) : ($game_config->max) - ($value->total_bet_money);
            $betList[10004]->max = isset($betList[10004]->max) ? $betList[10004]->max - ($value->total_bet_money) : ($game_config->max) - ($value->total_bet_money);
        } else if ($betList[$value->ls_markets_id]->markets_id == 10005 || $betList[$value->ls_markets_id]->markets_id == 10006 || $betList[$value->ls_markets_id]->markets_id == 10007) {
            $betList[10005]->max = isset($betList[10005]->max) ? $betList[10005]->max - ($value->total_bet_money) : ($game_config->max) - ($value->total_bet_money);
            $betList[10006]->max = isset($betList[10006]->max) ? $betList[10006]->max - ($value->total_bet_money) : ($game_config->max) - ($value->total_bet_money);
            $betList[10007]->max = isset($betList[10007]->max) ? $betList[10007]->max - ($value->total_bet_money) : ($game_config->max) - ($value->total_bet_money);
        }
    }
}
...
<div id="mini_wide_wrap">
    ...
    <div class="mini_wide_left">
    	<div class="mini_left_title">
        	<div class="mini_left_title_game">엔트리 EOS 파워볼</div>
            <div class="mini_left_title_box">제 <span class="mini_left_title_box_font displayRound" style="display: none"></span><span class="mini_left_title_box_font round"></span> 회차</div>
        	...
        	<div class="mini_left_list">
            	<ul>
                    <?php if('ON' == config(App::class)->IS_EOS_POWERBALL){ ?>
                            <a href="/web/minigame?betType=3"><li style="border:1px solid #009dd9; background: #232323;"><img src="/assets_w/images/icon_mini01.png" width="18"> 엔트리 EOS 파워볼</li></a>
                        <?php } ?>
    ...
    <div class="mini_wide_center">
    	<div class="mini_title_wrap">
        	<div class="mini_title">엔트리 EOS 파워볼 &nbsp;&nbsp; <span class="mini_round"> 제 <span class="mini_left_title_box_font displayRound"></span> 회차 </span> &nbsp;&nbsp;<span class="mini_time mini_left_title_box_font remain_time"></span></span></div>
        </div>
		<div class="mini_movie_wrap">
		    <div class="mini_movie_inner"><iframe defer src="https://ntry.com/scores/eos_powerball/5min/main.php" width="830" height="641" scrolling="no" frameborder="0"></iframe></div>
        </div> 
    ...
    <!-- mini_betting_cart -->
        ...
        <div class="mini_cart_wrap">
            <table width="100%" cellspacing="2" cellpadding="0">
                <tr>
                    <td width="10%"><a href="javascript:void(0);" onclick="addMiniGameBet(10001, <?= $betList[10001]->bet_price ?>, <?= session()->get('money') ?>, <?= isset($betList[10001]->max) ? $betList[10001]->max : $game_config->max ?> ) "><span class="mini_power_btn1"><span class="mini_power_font markets_id_10001"><?= $betList[10001]->markets_name ?></span><br><?= $betList[10001]->bet_price ?></span></a></td>
                    <td width="10%"><a href="javascript:void(0);" onclick="addMiniGameBet(10002, <?= $betList[10002]->bet_price ?>, <?= session()->get('money') ?>, <?= isset($betList[10002]->max) ? $betList[10002]->max : $game_config->max ?> ) "><span class="mini_power_btn2"><span class="mini_power_font markets_id_10002"><?= $betList[10002]->markets_name ?></span><br><?= $betList[10002]->bet_price ?></span></a></td>
                </tr>
            </table>
            <table width="100%" cellspacing="2" cellpadding="0">
                <tr>
                    <td width="10%"><a href="javascript:void(0);" onclick="addMiniGameBet(10004, <?= $betList[10004]->bet_price ?>, <?= session()->get('money') ?>, <?= isset($betList[10004]->max) ? $betList[10004]->max : $game_config->max ?> ) "><span class="mini_power_btn1"><span class="mini_power_font markets_id_10004"><?= $betList[10004]->markets_name ?></span><br><?= $betList[10003]->bet_price ?></span></a></td>
                    <td width="10%"><a href="javascript:void(0);" onclick="addMiniGameBet(10003, <?= $betList[10003]->bet_price ?>, <?= session()->get('money') ?>, <?= isset($betList[10003]->max) ? $betList[10003]->max : $game_config->max ?> ) "><span class="mini_power_btn2"><span class="mini_power_font markets_id_10003"><?= $betList[10003]->markets_name ?></span><br><?= $betList[10004]->bet_price ?></span></a></td>
                </tr>
            </table>
            <table width="100%" cellspacing="2" cellpadding="0">
                <tr>
                    <td width="10%"><a href="javascript:void(0);" onclick="addMiniGameBet(10005, <?= $betList[10005]->bet_price ?>, <?= session()->get('money') ?>, <?= isset($betList[10005]->max) ? $betList[10005]->max : $game_config->max ?> ) "><span class="mini_power_btn3"><span class="mini_power_font markets_id_10005"><?= $betList[10005]->markets_name ?></span><br><?= $betList[10005]->bet_price ?></span></a></td>
                    <td width="10%"><a href="javascript:void(0);" onclick="addMiniGameBet(10006, <?= $betList[10006]->bet_price ?>, <?= session()->get('money') ?>, <?= isset($betList[10006]->max) ? $betList[10006]->max : $game_config->max ?> ) "><span class="mini_power_btn3"><span class="mini_check"></span><span class="mini_power_font markets_id_10006"><?= $betList[10006]->markets_name ?></span><br><?= $betList[10006]->bet_price ?></span></a></td>
                    <td width="10%"><a href="javascript:void(0);" onclick="addMiniGameBet(10007, <?= $betList[10007]->bet_price ?>, <?= session()->get('money') ?>, <?= isset($betList[10007]->max) ? $betList[10007]->max : $game_config->max ?> ) "><span class="mini_power_btn3"><span class="mini_power_font markets_id_10007"><?= $betList[10007]->markets_name ?></span><br><?= $betList[10007]->bet_price ?></span></a></td>                       
                </tr>
            </table>
        </div>
...
<script type="text/javascript">
        ...
        $(document).on('click', '.cart_btn1', function() {
            ...
            let memberBetList = [];
                ...
                $.ajax({
                    ...
                    let path = '/api/bet/addMiniBet?betType=3';
    ...
    const getBetList = function(currentPage) {
        ...
        $.ajax({
            url: '/minigame/selectMemberMiniGameBet?game=powerball&betType=3',
            type: 'post',
            data: param,
        }).done(function(response) {
