...
<div id="mini_wide_wrap">
    ...
    <div class="mini_wide_left">
    	<div class="mini_left_title">
        	<div class="mini_left_title_game">엔트리 키노사다리</div>
        ...
        <div class="mini_left_list_wrap">
        	<div class="mini_left_list">
            	<ul>
                	...
                	<a href="/web/minigame?betType=5"><li style="border:1px solid #009dd9; background: #232323;"><img src="/assets_w/images/icon_mini01.png" width="18">&nbsp; 엔트리 키노사다리</li></a>
                </ul>
            </div>
        </div>
    </div><!-- mini_wide_left -->
    ...
    <div class="mini_wide_center">
    	<div class="mini_title_wrap">
        	<div class="mini_title">엔트리 키노사다리 &nbsp;&nbsp; <span class="mini_round"> 제 <span class="mini_left_title_box_font displayRound"></span> 회차 </span> &nbsp;&nbsp;<span class="mini_time mini_left_title_box_font remain_time"></span></span></div>
        </div>
		<div class="mini_movie_wrap">
        <div class="mini_movie_inner"><iframe defer src="https://ntry.com/scores/keno_ladder/live.php" width="830" height="641" scrolling="no" frameborder="0"></iframe></div>
        </div> 
    ...
    <!-- mini_betting_cart -->
        ...
        <div class="mini_cart_wrap">
            <table width="100%" cellspacing="2" cellpadding="0">
                <tr>
                    <td width="10%"><a href="javascript:void(0);" onclick="addMiniGameBet(12001, <?=$betList[12001]->bet_price?>, <?=session()->get('money')?>, <?= isset($betList[12001]->max) ? $betList[12001] -> max : $game_config -> max?>)"><span class="mini_power_btn1"><span class="mini_power_font markets_id_12001"><?=$betList[12001]->markets_name?></span><br><?= $betList[12001]->bet_price ?></span></a></td>
                    <td width="10%"><a href="javascript:void(0);" onclick="addMiniGameBet(12002, <?=$betList[12002]->bet_price?>, <?=session()->get('money')?>, <?= isset($betList[12002]->max) ? $betList[12002] -> max : $game_config -> max?>)"><span class="mini_power_btn2"><span class="mini_power_font markets_id_12002"><?=$betList[12002]->markets_name?></span><br><?= $betList[12002]->bet_price ?></span></a></td>                                                                                                                  
                </tr>
            </table>
            <table width="100%" cellspacing="2" cellpadding="0">
                <tr>
                    <td width="10%"><a href="javascript:void(0);" onclick="addMiniGameBet(12003, <?=$betList[12003]->bet_price?>, <?=session()->get('money')?>, <?= isset($betList[12003]->max) ? $betList[12003] -> max : $game_config -> max?>)"><span class="mini_power_btn1"><span class="mini_power_font markets_id_12003"><?=$betList[12003]->markets_name?></span><br><?= $betList[12003]->bet_price ?></span></a></td>
                    <td width="10%"><a href="javascript:void(0);" onclick="addMiniGameBet(12004, <?=$betList[12004]->bet_price?>, <?=session()->get('money')?>, <?= isset($betList[12004]->max) ? $betList[12004] -> max : $game_config -> max?>)"><span class="mini_power_btn2"><span class="mini_power_font markets_id_12004"><?=$betList[12004]->markets_name?></span><br><?= $betList[12004]->bet_price ?></span></a></td>                                                                                                                  
                </tr>
            </table>
            <table width="100%" cellspacing="2" cellpadding="0">
                <tr>
                    <td width="10%"><a href="javascript:void(0);" onclick="addMiniGameBet(12005, <?=$betList[12005]->bet_price?>, <?=session()->get('money')?>, <?= isset($betList[12005]->max) ? $betList[12005] -> max : $game_config -> max?>)"><span class="mini_power_btn1"><span class="mini_power_font markets_id_12005"><?=$betList[12005]->markets_name?></span><br><?= $betList[12005]->bet_price ?></span></a></td>
                    <td width="10%"><a href="javascript:void(0);" onclick="addMiniGameBet(12006, <?=$betList[12006]->bet_price?>, <?=session()->get('money')?>, <?= isset($betList[12006]->max) ? $betList[12006] -> max : $game_config -> max?>)"><span class="mini_power_btn2"><span class="mini_power_font markets_id_12006"><?=$betList[12006]->markets_name?></span><br><?= $betList[12006]->bet_price ?></span></a></td>                                                                                                                  
                </tr>
            </table>  
        </div>
    ...
    <!-- mini_game_result -->
        <div class="mini_conter_wrap">
            ...
            <div class="mini_center_result tab_container_multi">
                    ...
                    <div id="kladder_pattern_1" class="tab_content_multi"></div>
                    <div id="kladder_pattern_2" class="tab_content_multi"></div>
                    <div id="kladder_pattern_3" class="tab_content_multi"></div>
...
<script type="text/javascript">
        ...
        $(document).on('click', '.cart_btn1', function () {
            ...
            let memberBetList = [];
                ...
                $.ajax({
                    ...
                    let path = '/api/bet/addMiniBet?betType=5';
    ...
    const addMiniGameBet = function(markets_id, bet_price, money, max){
        ...
        if(markets_id == 12001 ||markets_id == 12003 || markets_id == 12005) {
        	$('.select_game').addClass('mini_power_c_btn1');
        }
        if(markets_id == 12002 ||markets_id == 12004 || markets_id == 12006) {
    ...
    const getBetList = function(currentPage){
        ...
        $.ajax({
            url: '/minigame/selectMemberMiniGameBet?betType=5',
            type: 'post',
            data: param,
        }).done(function (response) {
    ...
    const getPatternData = function(){
        ...
        $.ajax({
            ...
            $('#kladder_pattern_'+patternType).empty();
            $('#kladder_pattern_'+patternType).append(html);
            
            // 삭제할 li 갯수
            let delCount = $('#kladder_pattern_'+patternType).find('li').length - 20;
            $('#kladder_pattern_'+patternType + ' li').each(function (index, item){
                if(index < delCount){
                    item.remove();
                }
            });
