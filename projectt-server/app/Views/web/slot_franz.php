...
<?= view('/web/common/header_wrap') ?>
    ...
    <div class="title_wrap"><div class="title">슬롯게임</div></div>
    ...
    <div id="contents_slot_wrap" class="original_wrapper">
        <div class="contents_box game__board-wrap">
            ...
            <!-- </div> -->
                    <div class="slot_game_wrapper">
                        <ul class="slot_game_list">
                            ...
                            <li class="">신규게임</li>
                            <li class="">즐겨찾기</li>
                            <li class=""><button id="open-popup"><div style="display:flex; align-items:center; justify-content:center; margin:-5px -5px 0 -5px;"><span class="material-symbols-outlined">apps</span>&nbsp;&nbsp;고급옵션</div></button></li>
                        </ul>                
                        <div class="slot_game_data_wrapper">
                            <span class="slot_game_title">전체게임</span>
                            <hr color="#01aef0" style="margin-bottom: 20px;">

                           <div class="slot_game_data_images">
                                <?php                          
                                $img = "/assets_w/images/slot_casino/";
                                $slot_game_name = "슬롯게임";

                                for($i = 1; $i < 22 ;$i++){
                                    echo '<div style="width:100%;"><img style="width: 195px;  border-radius: 10px;" src="'.$img.'/'.$i.'.png">';
                                    echo '<div class="slot_game_desc">'.$slot_game_name;
                                    echo '<div class="slot_game_star"><span class="material-symbols-rounded">star</span></div></div></div>';
                                }                          
                                ?>
                                <br><br><br>
                            </div>
                    ...
                    <div id="slot-popup-overlay">
                        <div class="slot-popup-wrapper">
                            <button id="close-popup"><span class="material-symbols-outlined" style="font-size: 35px !important; margin: 3px 3px 0 3px;">close</span></button>
                            <div class="slot-popup-header">
                                <p style="font-size: 20px; font-weight: bold;">|&nbsp;&nbsp;&nbsp;슬롯게임사 선택</p>
                                <img src="/assets_w/images/logo.png" style="width: 160px;">                   
                            </div>
                                <br>
                            <div id="slot-popup-content">
                                <?php                          
                                    $prvimg = "/assets_w/images/slot_providers/";
                                    $slot_prv_name = "슬롯게임 프러바이더스";
    
                                    for($j = 1; $j < 11 ;$j++){
                                        echo '<div style="width:100%;"><img style="width: 430px;" src="'.$prvimg.'/slot'.sprintf("%02d", $j).'.png">';
                                        echo '<div class="slot_provider_desc">'.$slot_prv_name;
                                        echo '</div></div>';
                                    }                          
                                ?>
                            </div>
