...
<div class="contents_wrap">
	<div class="contents_box">
        ...
        <?php if ($clickItemNum == "4" || $clickItemNum == "5") : ?>
        ...
        <?php else: ?>
            ...
            <div class="con_box20 bet_history_wrap1" id="<?= $bet->idx;?>" >
                ...
                <div class="bet_history" >
                    <ul class="bet_history_span">
                        <li class="font03">전체배당(보너스포함)&nbsp;&nbsp;<span class="font06">x <?= number_format($bet->total_bet_price, 2) ?></span></li>
                        <li class="font03">보너스(아이템)&nbsp;&nbsp;
                            <span class="font06">x <?= number_format($bet->bonus_price, 2) ?></span>
                            <span class="font10">(x <?= number_format($bet->item_bonus_price, 2) ?>)</span>
                        </li>
                        <li class="font03">아이템&nbsp;&nbsp;<span class="font10">
                        <?php
                            if ($bet->item_idx == 0) {
                                $itemName = '미사용';
                            } else {
                        ...
                        <li class="font03">베팅슬립&nbsp;&nbsp;<span class="font08"><?=$bet->is_betting_slip?></span></li>
                        <li class="font03">베팅금액&nbsp;&nbsp;<span class="font08"><?= number_format($bet->total_bet_money) ?> 원</span></li>
                        <li class="font03">예상적중금액&nbsp;&nbsp;<span class="font08"><?= number_format($bet->total_bet_money * number_format($bet->total_bet_price, 2)) ?>원</span></li>
                        <li class="font03">적중금액&nbsp;&nbsp;<span class="font06"><?= number_format($bet->take_money) ?>원</span></li>
                    </ul>
                    <ul class="bet_history_span">
                        <li class="font03">베팅시간&nbsp;&nbsp; <span class="font08"><?=date("m-d", strtotime($bet->create_dt))?> (<?=DateTimeUtil::getWeekDay($bet->create_dt)?>) <?=date("H:i:s", strtotime($bet->create_dt))?></span></li>
                        <li class="font03">베팅결과&nbsp;&nbsp; <span class="<?= $class ?>"><?= $result ?></span></li>
                    </ul>
                </div>
            ...
            <div class="scroll_h_wrap">
                <div class="scroll_h_inner">
                    <div class="con_box20 " id="<?= $bet['idx'] ?? '' ?>">
                        <div class="bet_history_tr">
