...
<div id="mini_wide_wrap">
    ...
    <div class="mini_wide_left">
    	<div class="mini_left_title">
        	<div class="mini_left_title_game">유로컵(BET365)</div>
            <div class="mini_left_title_box">제 <span class="mini_left_title_box_font" id="round"></span> 회차</div>
            <div class="mini_left_title_box">베팅마감 <span class="mini_left_title_box_font close_time_3">00:00</span></div>
		</div>
        <div class="mini_left_list_wrap">
        	<div class="mini_left_list">
            	<ul>
                    ...
                    <a href="/web/euroCup"><li style="border:1px solid #009dd9; background: #232323;"><img src="/assets_w/images/icon_mini02.png" width="18">&nbsp; 유로컵</li></a>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="mini_wide_center">
        <div class="vsports_center_wrap">
            <div class="vsports_title_wrap">
                <div class="vsports_title">유로컵(BET365) &nbsp;&nbsp; 남은시간 <span class="mini_left_title_box_font close_time_3"></span></span></div>
...
//console.log('miniutes : '+miniutes+' seconds : '+seconds+' close_time : '+close_time);
    ...
    const getBetList = function(currentPage){
        ...
        $.ajax({
            url: '/minigame/selectMemberMiniGameBet?betType=6&leagueType=4',
            type: 'post',
            data: param,
        }).done(function (response) {
            console.log(response);
