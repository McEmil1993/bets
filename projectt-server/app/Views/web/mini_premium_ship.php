...
<div id="mini_wide_wrap">
    ...
    <div class="mini_wide_left">
    	<div class="mini_left_title">
        	<div class="mini_left_title_game">프리미어쉽(BET365)</div>
            <div class="mini_left_title_box">제 <span class="mini_left_title_box_font" id="round"></span> 회차</div>
            <div class="mini_left_title_box">베팅마감 <span class="mini_left_title_box_font close_time_1">00:00</span></div>
		</div>
        <div class="mini_left_list_wrap">
        	<div class="mini_left_list">
            	<ul>
                	<a href="/web/premiumShip"><li style="border:1px solid #009dd9; background: #232323;"><img src="/assets_w/images/icon_mini02.png" width="18">&nbsp; 프리미어쉽</li></a>
                	<a href="/web/superLeague"><li><img src="/assets_w/images/icon_mini02.png" width="18">&nbsp; 슈퍼리그</li></a>
                	<a href="/web/worldCup"><li><img src="/assets_w/images/icon_mini02.png" width="18">&nbsp; 월드컵</li></a>
    ...
    <div class="mini_wide_center">
        <div class="vsports_center_wrap">
            <div class="vsports_title_wrap">
                <div class="vsports_title">프리미어쉽(BET365) &nbsp;&nbsp; 남은시간 <span class="mini_left_title_box_font close_time_1"></span></span></div>
                ...
                <div class="vsports_movie_wrap">
                    <div class="vsports_movie_inner"><iframe id="soccer_screen" defer src="http://odds-info.net/b3mv/?vn=1" class="bsoccer_video" width="514" height="290" scrolling="no" frameborder="0"></iframe></div>
                </div>  
            </div>  
            <div class="vsports_s_right active">
				<div id="soccer_game_list"></div>

                <div class="mini_tab_wide" style="margin-bottom: 7px">
...
//console.log('miniutes : '+miniutes+' seconds : '+seconds+' close_time : '+close_time);
    ...
    const getBetList = function(currentPage){
        ...
        $.ajax({
            url: '/minigame/selectMemberMiniGameBet?betType=6&leagueType=1',
            type: 'post',
            data: param,
        }).done(function (response) {
            console.log(response);
