...
<div class="title_wrap"><div class="title">골드템</div></div>

<div id="contents_wrap" class="contents_wrap">
    <div class="contents_box"> 
        <div class="con_box00">
            <div class="g_info_wrap">
                <div class="g_info1">불스 아이템 규정</div>              
                <div class="g_info3">
                    <span class="g_info_num">1</span>&nbsp;  G머니는 <span class="font10">충전금액의 0.001% </span>가 자동 적립됩니다.<span class="font10">ex) 10,000원 충전시 "10 G머니" 적립</span><br>
                    <span class="g_info_num">2</span>&nbsp;  G머니로 불스마켓에서 아이템을 구매 후 스포츠 배팅에 대해서만 사용이 가능합니다.<br>
                    <span class="g_info_num">3</span>&nbsp;  아이템은 스포츠 배팅전 사용이 가능하며, <span class="font10">배팅이 진행중이거나 마감된 배팅에 대해서는 적용이 불가</span>합니다.<br>
                    <span class="g_info_num">4</span>&nbsp;  아이템은 스포츠 배팅을 주로 이용해주시는 회원분들께 지원되는 이벤트로 인하여, 가입이후 <span class="font10">카지노, 미니게임만 이용하셨을경우 사용이 불가함</span>을 알려드립니다.<br>
                    <span class="g_info_num">5</span>&nbsp;  시스템에 의하여 스포츠+카지노 / 스포츠 + 미니게임의 이용비율에서 <span class="font10">스포츠 비율이 낮을경우 배팅취소 및 아이템 회수처리</span>가 진행되오니 해당내용 참고하여주시기 바랍니다.<br>
					<span class="g_info_num">※</span>&nbsp;  <span class="font10">주로 이용하시는 배팅이 " 카지노/미니게임 " 이신 회원분께서는 아이템 사용전 반드시 고객센터를 통해 아이템 사용 가능 여부에 대한 문의 후 이용해주시기 바랍니다.</span><br>
        ...
        <div class="con_box10">
            <div class="g_info_wrap">
                <div class="g_info1">불스 아이템 이용안내</div>              
                <div class="g_info3">
                    <span class="g_info_num">1</span>&nbsp;  아이템은 적립 포인트로만 구매가 가능하며, 보유머니로는 구매가 불가합니다.<br>
                    <span class="g_info_num">2</span>&nbsp;  아이템 구매시 아이템의 가격만큼 마일리지가 차감됩니다.<br>
					<span class="g_info_num">3</span>&nbsp;  구매한 아이템은 환불이 불가능하며, 1경기에만 아이템이 적용됩니다.<br>
                    <span class="g_info_num">4</span>&nbsp;  아이템은 인플레이 배팅은 사용이 불가하며, 오직 스포츠 페이지에서만 사용이 가능합니다.<br>
					<span class="g_info_num">5</span>&nbsp;  아이템 사용시 당첨/미당첨 결과에 관계없이 사용하신 아이템은 소멸됩니다.<br>
                    <span class="g_info_num">6</span>&nbsp;  사용하신 아이템은 배팅내역에서 확인이 가능하며, 아이템 사용은 배팅카트에서 적용이 가능합니다.<br>
                </div>
            </div>
        </div>
		<div class="con_box10">
            <div class="g_info_wrap">
                <div class="g_info1">불스 아이템 목록</div> 
				<div class="g_info2" style="margin-top:15px">★ 배당패치 ★ (배당UP 아이템)</div>
				...
				<div class="g_info2" style="margin-top:15px">★ 환급패치 ★ (페이백 아이템)</div>
				...
				<!-- 적특패치 숨김처리 -->
				<!-- <div class="g_info2" style="margin-top:15px">★ 적특패치 ★ (미적중 쉴드 아이템)</div>
        ...
        <div class="con_box10">
            <div class="g_info_wrap">
                <div class="g_info1">불스상점</div>              
                <div class="g_info2">★ 배당패치 ★ (배당UP 아이템)</div>              
                <div class="g_info3">
					<table width="100%" border="0" cellpadding="0" cellspacing="1" class="g_table">
						<tr>
						  <td bgcolor="#232323" align="center" width="20%">사용명</td>
							<td bgcolor="#232323" align="center">설명</td>
							<td bgcolor="#232323" align="center" width="10%">가격</td>
							<td bgcolor="#232323" align="center" width="10%">구매하기</td>                    
						</tr>
						<?php
						...
						?>
						<tr>
							<td bgcolor="#2b2b2b" align="center"><?=$item['name']?></td>
							<td bgcolor="#2b2b2b" align="center"><?=$desc?></td>
							<td bgcolor="#2b2b2b" align="center"><span class="g_font1"><?=$buyType ?> <?=number_format($item['price'])?></span></td>
							<td bgcolor="#2b2b2b" align="center"><span class="g_btn" style="cursor: pointer" onclick="fnBuyItem(<?=$item['id']?>,'<?=$item['name']?>',<?= $item['price']?>)">구매</span></td>
						</tr>
						<?php } endforeach;?>
					</table>
                </div>
				<div class="g_info2">★ 환급패치 ★ (페이백 아이템)</div>              
                <div class="g_info3">
					<table width="100%" border="0" cellpadding="0" cellspacing="1" class="g_table">
					<tr>
						  <td bgcolor="#232323" align="center" width="20%">사용명</td>
					...
					?>
						<tr>
							...
							<td bgcolor="#2b2b2b" align="center"><?=$desc?></td>
							<td bgcolor="#2b2b2b" align="center"><span class="g_font1"><?=$buyType ?> <?=number_format($item['price'])?></span></td>
							<td bgcolor="#2b2b2b" align="center"><span style="cursor: pointer" class="g_btn" onclick="fnBuyItem(<?=$item['id']?>,'<?=$item['name']?>',<?= $item['price']?>)">구매</span></td>
						</tr>
						<!-- <tr>
				...
				<!-- 적특패치 숨김 처리 -->
                <!-- <div class="g_info2">★ 적특패치 ★ (미적중 쉴드 아이템)</div>              
                <div class="g_info3">
					<table width="100%" border="0" cellpadding="0" cellspacing="1" class="g_table">
						<tr>
		...
		<div class="g_title2">나의 아이템</div>
        <div class="con_box10">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="g_table">
                <tr>
                    <td width="60%" class="g_list_title1">보유중인 아이템</td>                    
                    <td width="20%" class="g_list_title1">구매일</td>
                    <td width="20%" class="g_list_title1">사용여부</td>
                </tr>
                <?php
