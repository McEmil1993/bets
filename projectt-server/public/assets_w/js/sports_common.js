...
function changeWillWinMoney() {
    ...
    if('ON' == isClassic){
        ...
        betSlip = JSON.parse(sessionStorage.getItem("betSlip"));
    }
...
function calcMaxMoney(max_bet_money) {
    ...
    /*if (Number.isNaN(inputBetMoney)) {
     inputBetMoney = $('#betting_slip_money').val(0);
    }else{
        let data = inputBetMoney.replace(/,/gi,""); //변경작업
    }
...
// 베팅슬립 추가
function addBetSlip(betId, betPrice, betListIndex, betOddsTypes, betOddsTypesDisplay, betMarketType, team1, team2, betBaseLine, fixtureId, fixture_start_date, leagues_m_bet_money, betMarketId, betName) {
...
function displayBetSlip() {
    ...
    if(null != sessionData){
        ...
        for(i=0; i<sessionData.length; ++i){
            ...
            let betName = sessionData[i]['betName'];
...
function openBetData(fixture_id){
    ...
    const target = $(document).find("#fixture_row_"+fixture_id);
    // mobile click
    if( !target.find(".sports_s_right").hasClass("active") ){
    ...
    // PC click
    if( !$(document).find("body").hasClass("mobile") ){
        target.find(".sports_s_right").addClass("active");
        target.addClass("active");
    }
    ...
    $.ajax({
        ...
        for (const[key, fixture_list] of Object.entries(list)) {
                    ...
                    for (const[marketKey, game_list] of Object.entries(order_list)) {
                        ...
                        if(Object.keys(game_list[firstKey]['bet_data']).length > 0){
                            ...
                            if((marketKey != 1 && marketKey != 52 && marketKey != 226) || !mobileCheck()){
                                html += `
                                    <div class='bet_list1_wrap_in_title ${$sportsLineColor}'>
                                        ${marketsName}
                                        <span class='bet_list1_wrap_in_title_right'></span>
                                    </div>
                                    <ul class='bet_list1_wrap_in bet_list1_wrap_in_new ddtesttteadsfasdfasdfasdfasdfasf' id='market_${marketKey}'>
                                `;
                            }
                        }
                        ...
                        for (const[gameKey, game] of Object.entries(game_list)) {
                            ...
                            if (1 == game['menu']) {
                                ...
                                if (Object.keys(game['bet_data']).length == 3) {
                                    ...
                                    if((1 == game['bet_status'] && 1 == game['display_status'] && false == isMainBetLock) || checkTime > betweenTime){
                                        if((marketKey != 1 && marketKey != 52 && marketKey != 226) || !mobileCheck()){
                                            html += "<li class='bet_list_td w30 odds_btn' data-bet-status='"+ game['bet_status'] +"'  data-index='"+ bGameKey+"'"+
                                                    ...
                                                    "><span class='sports_team_txt'>"+game['fixture_participants_1_name']+"</span> <span class='betin_right bet_font1'>"+game['win']+"</span></li>";
                                            html += "<li class='bet_list_td w30 odds_btn' data-bet-status='"+ game['bet_status'] +"'  data-index='"+ bGameKey+"'"+
                                                    ...
                                                    ">무 <span class='betin_right bet_font1'>"+game['draw']+"</span></li>";
                                            html += "<li class='bet_list_td w30 odds_btn' data-bet-status='"+ game['bet_status'] +"'  data-index='"+ bGameKey+"'"+
                                                    ...
                                                    "><span class='sports_team_txt'>"+game['fixture_participants_2_name']+"</span> <span class='betin_right bet_font1'>"+game['lose']+"</span></li>";
                                        }
                                    }else{
                                        isMainBetLock = true;
                                        if((marketKey != 1 && marketKey != 52 && marketKey != 226) || !mobileCheck()){
                                    ...
                                    if((1 == game['bet_status'] && 1 == game['display_status'] && false == isMainBetLock) || checkTime > betweenTime){
                                        if((marketKey != 1 && marketKey != 52 && marketKey != 226) || !mobileCheck()){
                                            html += "<li class='bet_list_td w50 odds_btn' data-bet-status='"+ game['bet_status'] +"'  data-index='"+ bGameKey+"'"+
                                                    " data-odds-type='win' data-bet-id='"+ game['win_bet_id'] +"' data-bet-price='"+ game['win'] +"'"+
                                                    " data-td-cell='"+game['win_bet_id']+"_"+game['fixture_start_date']+"' data-markets_name='"+ markets_name +"'"+
                                                    " data-markets_name_origin='"+markets_name_origin+"' data-markets_display_name='"+ markets_display_name +"'"+
                                                    " data-bet-name='"+game['win_bet_name']+"'"+
                                ...
                                if((1 == game['bet_status'] && 1 == game['display_status'] && false == isMainBetLock) || checkTime > betweenTime){
                                    ...
                                    html += "<li class='bet_list_td w50 odds_btn' data-bet-status='"+ game['bet_status'] + "'  data-index='"+ bGameKey+"'"+
                                            ...
                                            " data-markets_name_origin='"+markets_name_origin+"' data-markets_display_name='"+ markets_display_name +"'"+
                                            " data-bet-name='"+game['win_bet_name']+"'"+
                                            "><span class='sports_team_handy'>"+game['fixture_participants_1_name']+"(" + handValue_l + ")</span><span class='betin_right bet_font1'><img src='/assets_w/images/icon_h.gif' style='margin-right: 5px'>"+game['win']+"</span></li>";
                                    html += "<li class='bet_list_td w50 odds_btn' data-bet-status='"+ game['bet_status'] +"'  data-index='"+ bGameKey+"'"+
                                            " data-odds-type='"+game['fixture_participants_2_name']+"("+ handValue_r +")' data-bet-id='"+ game['lose_bet_id'] +"' data-bet-price='"+ game['lose'] +"'"+
                                            " data-td-cell='"+game['lose_bet_id']+"_"+game['fixture_start_date']+"' data-markets_name='"+ markets_name +"'"+
                                            " data-markets_name_origin='"+markets_name_origin+"' data-markets_display_name='"+ markets_display_name +"'"+
                                            " data-bet-name='"+game['lose_bet_name']+"'"+
                                            "><span class='sports_team_handy'>"+game['fixture_participants_2_name']+"(" + handValue_r + ")</span><span class='betin_right bet_font1'><img src='/assets_w/images/icon_h.gif' style='margin-right: 5px'>"+game['lose']+"</span></li>";
                                }else{
                                    // 자물쇠 처리
                                    html += "<li class='bet_list_td w50' data-bet-status='"+ game['bet_status'] + "'"+
                                            "><span class='sports_team_handy'>"+game['fixture_participants_1_name']+"(" + handValue_l + ")</span><span class='betin_right bet_font1'><img src='/images/icon_lock.png' alt='lock' width='13'></span></td>"+
                                            "<li class='bet_list_td w50' data-bet-status='"+ game['bet_status'] + "'"+
                                            "><span class='sports_team_handy'>"+game['fixture_participants_2_name']+"(" + handValue_r + ")</span><span class='betin_right bet_font1'><img src='/images/icon_lock.png' alt='lock' width='13'></span></td>";
                            ...
                            // 언더오버
                                ...
                                if((1 == over_status && 1 == game['display_status'] && false == isMainBetLock) || checkTime > betweenTime){
                                    html += "<li class='bet_list_td w50 odds_btn' data-bet-status='"+ over_status + "'  data-index='"+ bGameKey+"'"+
                                            ...
                                            ">오버("+ over_base_line + ") <span class='betin_right bet_font1'><img src='/assets_w/images/arr2.gif' style='margin-right: 5px'>"+over+"</span></li>";
                                    html += "<li class='bet_list_td w50 odds_btn' data-bet-status='"+ under_status + "'  data-index='"+ bGameKey+"'"+
                                            ...
                                            ">언더("+ under_base_line + ") <span class='betin_right bet_font1'><img src='/assets_w/images/arr1.gif' style='margin-right: 5px'>"+under+"</span></li>";
                                }else{
                                    // 자물쇠 처리
                                    html += "<li class='bet_list_td w50' data-bet-status='"+ over_status + "'"+
                                            ">오버("+ over_base_line + ") <span class='betin_right bet_font1'><img src='/images/icon_lock.png' alt='lock' width='13'></span></li>"+
                                            "<li class='bet_list_td w50' data-bet-status='"+ under_status + "'"+
                                            ">언더("+ under_base_line + ") <span class='betin_right bet_font1'><img src='/images/icon_lock.png' alt='lock' width='13'></span></li>";
                                    //html += getLockHtml('w50', game['menu'], game['bet_status'], "<span class='sports_team_handy'>"+game['fixture_participants_1_name']+"</span>(" + handValue_l + ")", "<span class='sports_team_handy'>"+game['fixture_participants_2_name']+"</span>(" + handValue_r + ")");
                                }
                                // html += "</tr>";
                                // 기타
                                ...
                                // html += "<tr>";
                                    ...
                                    if ( 'Yes' == tmBetName || 'No' == tmBetName) {
                                        ...
                                        if((1 == betData_yes['bet_status'] && 1 == game['display_status'] && false == isMainBetLock) || checkTime > betweenTime){
                                            // yes
                                            html += "<li class='bet_list_td w50 odds_btn' data-bet-status='"+ betData_yes['bet_status'] + "'  data-index='"+ bGameKey+"'"+
                                                ...
                                                " data-markets_name_origin='"+markets_name_origin+"' data-markets_display_name='"+ markets_display_name +"'"+
                                                " data-bet-name='"+bet_name_yes+"'"+
                                                ">"+display_bet_name_yes+"<span class='betin_right bet_font1'>"+betData_yes['bet_price']+"</span></li>";

                                            // no
                                            html += "<li class='bet_list_td w50 odds_btn' data-bet-status='"+ betData_no['bet_status'] + "'  data-index='"+ bGameKey+"'"+
                                                ...
                                                " data-markets_name_origin='"+markets_name_origin+"' data-markets_display_name='"+ markets_display_name +"'"+
                                                " data-bet-name='"+bet_name_no+"'"+
                                                ">"+display_bet_name_no+"<span class='betin_right bet_font1'>"+betData_no['bet_price']+"</span></li>";
                                        }else{
                                            html += "<li class='bet_list_td w50' data-bet-status='"+ betData_yes['bet_status'] + "'"+
                                                    ">"+ display_bet_name_yes + ") <span class='betin_right bet_font1'><img src='/images/icon_lock.png' alt='lock' width='13'></span></li>"+
                                                    "<li class='bet_list_td w50' data-bet-status='"+ betData_no['bet_status'] + "'"+
                                                    ">"+ display_bet_name_no + ") <span class='betin_right bet_font1'><img src='/images/icon_lock.png' alt='lock' width='13'></span></li>";
                                            //html += getLockHtml('w50', game['menu'], game['bet_status'], "<span class='sports_team_handy'>"+game['fixture_participants_1_name']+"</span>(" + handValue_l + ")", "<span class='sports_team_handy'>"+game['fixture_participants_2_name']+"</span>(" + handValue_r + ")");
                                        }
                                    } else {
                                        ...
                                        for (const[betName, value] of Object.entries(game['bet_data'])) {
                                            ...
                                            // 정확한 스코어, 그외 점수 제외
                                            if (game['markets_id'] == 6 && display_bet_name == '그외 점수') {
                                                continue;
                                            }
                                            ...
                                            if (game['markets_id'] == 427) {
                                                ...
                                                if((1 == betData['bet_status'] && 1 == game['display_status'] && false == isMainBetLock) || checkTime > betweenTime){
                                                    html += "<li class='bet_list_td "+classWidth+" odds_btn' data-bet-status='"+ betData['bet_status'] + "'  data-index='"+ bGameKey+"'"+
                                                            ...
                                                            " data-markets_name_origin='"+markets_name_origin+"' data-markets_display_name='"+ markets_display_name +"'"+
                                                            " data-bet-name='"+betData['bet_name']+"'"+
                                                            ">"+ display_bet_name + " <span class='betin_right bet_font1'><img src='"+img+"' alt='"+ alt +"' style='margin-right: 5px'>"+betData['bet_price']+"</span></li>";
                                                }else{
                                                    html += "<li class='bet_list_td "+classWidth+"' data-bet-status='"+ betData['bet_status'] + "'"+
                                                            ">"+ display_bet_name + " <span class='betin_right bet_font1'><img src='/images/icon_lock.png' alt='lock' width='13'></span></li>";
                                                }
                                            } else {
                                                if((1 == betData['bet_status'] && 1 == game['display_status'] && false == isMainBetLock) || checkTime > betweenTime){
                                                    html += "<li class='bet_list_td "+classWidth+" odds_btn' data-bet-status='"+ betData['bet_status'] + "'  data-index='"+ bGameKey+"'"+
                                                            ...
                                                            " data-markets_name_origin='"+markets_name_origin+"' data-markets_display_name='"+ markets_display_name +"'"+
                                                            " data-bet-name='"+betData['bet_name']+"'"+
                                                            ">"+ display_bet_name + " <span class='betin_right bet_font1'>"+betData['bet_price']+"</span></li>";
                                                }else{
                                                    // 자물쇠 처리
                                                    html += "<li class='bet_list_td "+classWidth+"' data-bet-status='"+ betData['bet_status'] + "'"+
                                                            ">"+ display_bet_name + " <span class='betin_right bet_font1'><img src='/images/icon_lock.png' alt='lock' width='13'></span></li>";
            ...
            if(isMobile){
                ...
                $(document).find("#fixture_row_"+fixture_id).find(".dropdown3").append(html);
            }else{
                // $(".dropdown3 li").remove();
...
const notifyCloseBtn = function(obj){
    ...
    // let thisParent = $(obj).parent().parent().parent();
    let thisParent = $(obj).parents(".sports_cart_bet");
...
const maxBtnClick = function(){
   ...
   checkMaxWin =  maxWinning(myHoldingMoney);
   if(checkMaxWin){
      return;
   }*/
   let maxBetMoney = $('.max_bet_money').text();
   ...
   //let maxBetMoney = Number($('.max_bet_money').text());
    ...
    for (let slip of betSlip) {
        let leagues_m_bet_money = 0;
        if('ON' == isClassic)
            leagues_m_bet_money = $(slip).data('leagues_m_bet_money');
        else
            leagues_m_bet_money = slip.leagues_m_bet_money;
        
        if (totalMax >= +leagues_m_bet_money) {
            totalMax = leagues_m_bet_money;
        }
    }
        ...
        $.ajax({
            ...
            if (check === true) {
                ...
                if('OFF' == isClassic){
                    ...
                    location.href = "/web/betting_history?menu=b&bet_group=9&clickItemNum=9";
                }
                $('#loadingCircle').hide();
                return;
            } else {
            ...
            let path = '/api/bet/addBet?bet_group=2';
...
// 모바일 더보기 클릭
const btn_more_click = function(fixture_id){
    console.log('btn_more : '+ $('.btn_more_'+fixture_id).text());
    $('#more_content_area_'+fixture_id).slideToggle();
    $('.btn_more_'+fixture_id).text($('.btn_more_'+fixture_id).text() == '더보기 ▼' ? '숨기기 ▲' : '더보기 ▼');
};