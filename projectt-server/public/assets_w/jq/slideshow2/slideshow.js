...
(function(a){
    a.fn.number_slideshow=function(p){
        ...
        var o=p&&p.slideshow_time_interval?p.slideshow_time_interval:"1000";
...
/* ysk 기본설정 */
            ...
            $(function() {
                $("#number_slideshow").number_slideshow({
                    ...
                    slideshow_window_background_color: "#000000", // ysk 컷이 바뀔때 배경색
                    slideshow_window_padding: '0',
                    slideshow_window_width: '2560', // ysk 가로값
                    slideshow_window_height: '330', // ysk 세로값
                    slideshow_border_size: '0',
                    slideshow_transition_speed:3000, // ysk 컷이 바뀔때 속도
                    ...
                    slideshow_button_background_color: '#000000', // ysk 점의 비활성화시 색상
                    slideshow_button_current_background_color: '#ffffff', // ysk 점의 선택시 색상
                    slideshow_button_border_color: '#000',
                    slideshow_loading_gif: 'loading.gif',
